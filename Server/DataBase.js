var db = {
	...
	clearAndSeedDataBase: function () {
		...
		db.createFaction(new Faction({name: "Emerald", colors: COLOR.factions.a}));
		db.createFaction(new Faction({name: "Ruby", colors: COLOR.factions.b}));
		db.createFaction(new Faction({name: "Sapphire", colors: COLOR.factions.c}));
		db.createFaction(new Faction({name: "Amethyst", colors: COLOR.factions.d}));
		db.createFaction(new Faction({name: "Topaz", colors: COLOR.factions.e}));
